...
public class Quiz2result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz2result);
        ...
        imgbutton1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View w) {
                Intent jumpage=new Intent(Quiz2result.this,Chapter2.class);
