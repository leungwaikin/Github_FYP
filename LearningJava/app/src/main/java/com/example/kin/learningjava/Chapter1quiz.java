...
public class Chapter1quiz extends AppCompatActivity {
    ...
    private Quiz1QuestionBank mQuestionLibrary = new Quiz1QuestionBank();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(Chapter1quiz.this, Quiz1HighestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Chapter1quiz.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Chapter1quiz.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
