...
public class Chapter4a extends AppCompatActivity {
    WebView mwebview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mwebview.loadUrl("https://leungwaikin.000webhostapp.com/Chapter4a.html");
        ...
        jumppage2.setOnClickListener(new View.OnClickListener(){
            ...
            //On click function
            public void onClick(View w) {
                Intent jumpage=new Intent(Chapter4a.this,Chapter4b.class);
