...
public class MyDataBaseHelper1 extends SQLiteOpenHelper {
    ...
    // Database name
    public static String DATABASE_QUESTION = "questionBank1.db";
    // Current version of database
    private static final int DATABASE_VERSION = 1;
    // Database table name
    private static final String TABLE_QUESTION = "QuestionBank1";
     ...
     */
    public long addInitialQuestion (Question1 question) {
