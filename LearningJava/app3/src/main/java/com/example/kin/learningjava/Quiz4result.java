...
public class Quiz4result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz4result);
        ...
        imgbutton1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View w) {
                Intent jumpage=new Intent(Quiz4result.this,Chapter4.class);
