...
public class Chapter5quiz extends AppCompatActivity {
    ...
    private Quiz5QuestionBank mQuestionLibrary = new Quiz5QuestionBank();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            testfive=Integer.toString(mScore);
            BackgroundWorker background = new BackgroundWorker(Chapter5quiz.this);
            background.execute(type,name,testfive);
            Toast.makeText(Chapter5quiz.this, "Quiz5 completed", Toast.LENGTH_SHORT).show();
            Intent jumpage = new Intent(Chapter5quiz.this, Quiz1result.class);
            Bundle bundle = new Bundle();
            bundle.putString("score",testfive);// pass the current score to the second screen
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Chapter5quiz.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Chapter5quiz.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
