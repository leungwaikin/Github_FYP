...
public class Quiz6result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz6result);
        ...
        imgbutton1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View w) {
                Intent jumpage=new Intent(Quiz6result.this,Chapter6.class);
