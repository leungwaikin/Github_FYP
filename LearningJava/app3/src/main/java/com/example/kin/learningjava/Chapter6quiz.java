...
public class Chapter6quiz extends AppCompatActivity {
    ...
    private Quiz6QuestionBank mQuestionLibrary = new Quiz6QuestionBank();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            testsix=Integer.toString(mScore);
            BackgroundWorker background = new BackgroundWorker(Chapter6quiz.this);
            background.execute(type,name,testsix);
            Toast.makeText(Chapter6quiz.this, "Quiz2 completed", Toast.LENGTH_SHORT).show();
            Intent jumpage = new Intent(Chapter6quiz.this, Quiz1result.class);
            Bundle bundle = new Bundle();
            bundle.putString("score",testsix);// pass the current score to the second screen
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Chapter6quiz.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Chapter6quiz.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
